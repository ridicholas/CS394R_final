...
class GAIL(Module):
    ...
    def train(self, env, expert, render=False, exp_obs=None, exp_acts=None, r=None):
        ...
        for i in range(50):
            ...
            self.d.train()
            exp_scores = self.d.get_logits(exp_obs, exp_acts.squeeze())
            ...
            all_obs = FloatTensor(np.array(all_obs))

        return exp_rwd_mean, rwd_iter_means, exp_obs, exp_acts, all_obs, ep_acts
